...
{style src="/vendor/jqueryui/jquery-ui.min.css"}{/style}
...
<div class="front-menu-buttons">
    ...
    {if $smarty.cookies.cp_order_id}
        <a class="front-menu-button front-menu-btn-buy" style="display:none;" href="#" {action_attributes post="cp/:cp/orders/:order_id/offers" order_id=$smarty.cookies.cp_order_id}>
        ...
        {literal}
            <script>
                if ($(".cart-form .btn-buy").length) {
                    $(".front-menu-button.front-menu-btn-buy").show().on('click', function() {
...
{script src="/static/default/js/pina.slot-editor.js"}{/script}