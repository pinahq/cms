...
<fieldset>
    ...
    {include file="Skin/form-line-input.tpl" name="firstname" title="Имя" value=$user.firstname labelColumn=4}

    {include file="Skin/form-line-input.tpl" name="lastname" title="Фамилия" value=$user.lastname labelColumn=4}

    {include file="Skin/form-line-input.tpl" name="phone" title="Телефон" value=$user.phone labelColumn=4}
    ...
    {include file="Skin/form-line-input.tpl" type="password" name="new_password" title="Пароль" value="" labelColumn=4}

    {include file="Skin/form-line-input.tpl" type="password" name="new_password2" title="Повторите пароль" value="" labelColumn=4}
