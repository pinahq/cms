<div class="content-form form form-horizontal" {action_attributes put="cp/:cp/sale-content/:content_id" content_id=$content.id}>
    <div class="slot-content-container">
        {view get="sale-content/:content_id" content_id=$content.id content=$content}
    </div>
...
{literal}
    <script>
        Pina.slotEditor.on('sale-content', 'edit', function (currentBlock) {
