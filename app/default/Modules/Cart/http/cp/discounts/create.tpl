{content name="page_header"}{t}Добавить скидку{/t}{/content}

{form method="post" action="cp/:cp/discounts" class="form form-horizontal pina-form form-discount"}
<fieldset class="well">
    ...
    <div class="form-group">
        <div class="col-sm-10 col-sm-offset-2">
            <button class="btn btn-primary btn-raised">{t}Add{/t}</button>
        </div>
    </div>
