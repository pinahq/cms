...
<div class="panel">
    <div class="tab-content panel-body">
        {form action="cp/:cp/products/:resource_id/offers/:id" id=$offer.id resource_id=$offer.resource_id method="put" class="form form-horizontal pina-form form-offer"}
        {view get="cp/:cp/products/:resource_id/offers/block" display="form"}
